...
Debido a que no hay ninguna persona que sea del municipio 97 ni la entidad 14 en nuestra base de datos final se cambiaron por el municipio 96 y entidad 13.

```{r}
cpquery(bn, 
        event = ((AUTOS_GT1 == "1") & (MUJER == "1")), 
        evidence = ((EDAD_GT30 == "1") & (TRABAJO == "1") & (SEMANA == "1") & (MUN96 == "1") & (ENT13 == "1")), 
        n = 10^6)
